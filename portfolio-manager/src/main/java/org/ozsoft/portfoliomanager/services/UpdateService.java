...
public class UpdateService {
                ...
                for (Row row : sheet) {
                    if (row.getRowNum() > HEADER_ROWS) {
                        ...
                        if (cell != null && cell.getCellType() == CellType.STRING) {
                            ...
                            BigDecimal divRate = getExcelCellValue(row.getCell(DIV_RATE_COLUMN_INDEX)).setScale(2, java.math.RoundingMode.HALF_UP);
                            ...
                            divGrowth = divGrowth.setScale(2, java.math.RoundingMode.HALF_UP);
    ...
    public int updatePrices(Set<Stock> stocks) {
        ...
        Set<StockUpdater> updaters = new HashSet<>();
